...
VIDEO_DIR = os.path.join(PROJECT_ROOT, 'data')
MODEL_PATH = os.path.join(PROJECT_ROOT, 'models', 'crime_detection_model.h5')
...
def process_live_stream():
    ...
    global live_stream, should_stop_live_stream, current_prediction, live_stream_url
...
def start_live_stream():
    ...
    global live_stream, live_stream_url, should_stop_live_stream, current_prediction
...
def stop_live_stream_route():
    ...
    global live_stream, should_stop_live_stream
